export function StatsCard({ title, value, variant = "primary" }) {
	const variants = {
	...
	return (
		<div className="bg-white rounded-xl shadow-md overflow-hidden flex flex-col h-42 border border-gray-100">
