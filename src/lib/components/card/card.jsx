...
// Ignore unused props warning if necessary by not destructuring what we don't use right now,
// OR simply keep them. The logic above handles 'children' causing early return.
// We must keep the original function signature largely intact or we break existing usage.
// Re-exporting original function name.
