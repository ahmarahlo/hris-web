...
const BASE_STYLES =
	"flex flex-col items-center bg-white p-8 rounded-3xl w-full max-w-md mx-auto text-center border border-gray-100";
...
export function Alert({
	...
	cancelText,
	className = "",
	shadow = true, // New prop to control shadow
	...props
}) {
			...
			<div className="w-full">
				...
				{variant === "question" ? (
					...
					<div className="flex gap-3 w-full">
						<Button
							variant="info" // Pastikan variant ghost ada di Button.jsx
							onClick={onCancel}
